...
class PhoneOTPVerificationcopy extends StatefulWidget {
  const PhoneOTPVerificationcopy({Key? key}) : super(key: key);

  @override
  State<PhoneOTPVerificationcopy> createState() => _PhoneOTPVerificationState();
}

class _PhoneOTPVerificationState extends State<PhoneOTPVerificationcopy> {
                        ...
                        IconButton(
                          icon: Icon(
                            isOtpVisible
                                ...
                                : Icons
                                    .visibility, // Toggle icon based on isOtpVisible
                            color: Colors.blue,
                          ),
                          onPressed: () {
                            setState(() {
